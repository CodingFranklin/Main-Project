...
public class Pumpkin : Enemy
{
    ...
    [SerializeField] AudioClip pumpkinDieClip;
    ...
    protected override void Start()
    {
        ...
        currentHealth = GameManager.instance.pumpkinHealth;
    }
    ...
    {
        SoundEffectsManager.instance.PlaySoundEffectClip(pumpkinDieClip, transform, 1f);
        base.Die();
    }
