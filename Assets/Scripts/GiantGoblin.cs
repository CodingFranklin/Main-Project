...
public class GiantGoblin : Enemy
{
    [SerializeField] float moveSpeed;
    [SerializeField] AudioClip giantGoblinDieClip;
    ...
    protected override void Start()
    {
        ...
        currentHealth = GameManager.instance.giantGoblinHealth;
    }
    ...
    {
        SoundEffectsManager.instance.PlaySoundEffectClip(giantGoblinDieClip, transform, 1f);
        base.Die();
    }
